<x-workflow-layout>
    <x-slot name="header">
        ...
        <div class="text-[13px] text-vellum-muted mt-1.5 tracking-wide">
            Update personnel profile for {{ $user->name }}
        </div>
    </x-slot>
    ...
    <div class="space-y-6">
        <form method="POST" action="{{ route('employees.update', $user) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="password" class="block text-xs font-semibold text-vellum-muted uppercase tracking-wider mb-1.5">
                        New Password
                    </label>
                    <input
                        type="password"
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-semibold text-vellum-muted uppercase tracking-wider mb-1.5">
                ...
                <details class="group bg-surface rounded-md p-4 border border-hairline">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="contract_end_date" id="contract_end_date" value="{{ old('contract_end_date', $user->employeeProfile?->contract_end_date?->format('Y-m-d')) }}" class="w-full bg-surface-raised border border-hairline rounded-md text-vellum px-3 py-2 text-sm focus:ring-1 focus:ring-brass focus:border-brass focus:outline-none mt-1.5">
